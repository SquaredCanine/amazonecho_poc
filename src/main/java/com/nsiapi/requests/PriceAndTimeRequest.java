...
public class PriceAndTimeRequest implements requestInterface {
    ...
    public PriceAndTimeRequest(String origin, String destination, String date,String time, boolean arrival){
        this.date = date;
        this.time = time;
    ...
    private String getCode(String original){
        ArrayList<LocationsModel> locations = chooseCitySpeechlet.DB.getLocations(chooseCitySpeechlet.UNIQUE_USER_ID);
        switch(original){
            case "Berlin":
    ...
    public String getRequestUrl(){
        System.out.println(gotoUrl + originCode + "/" + destinationCode + "/" + date + "/" + time + "/outbound?" + passengers + timetype);
        return (gotoUrl + originCode + "/" + destinationCode + "/" + date + "/" + time + "/outbound?" + passengers + timetype);
    }
