...
public class MailClient {
        ...
        public void sendMail() {
            ...
            "Beste Reiziger,<br>"+
            "<br>"+
            "Voltooi jouw boeking door op <a href =\"" + gotoUrl + "\">deze</a> link te klikken. Fijne reis!<br>"+
            "<br>"+
            "<h3>Samenvatting van de reis</h3>"+
            "<div style=\"border-left:6px solid;border-color:#2196F3;color:#000;background-color:#ddffff;padding-left:16px\">Vetrek om: "+journey.getDepartureTime()+"  <br>"+
            "Vertrek van: "+journey.getOrigin().getName()+"</div>"+
            "<br>"+
            "<div style=\"border-left:6px solid;border-color:#0000FF;color:#000;background-color:#eedddd;padding-left:16px\">Aankomst om: "+journey.getArrivalTime()+"<br>"+
